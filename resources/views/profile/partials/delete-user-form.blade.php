<section class="space-y-6">
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            {{ __('Una volta cancellato, tutti i tuoi dati saranno perduti. Prima di cancellare il tuo profilo, per favore scarica tutti i dati che desideri tenere.') }}
        </p>
    </header>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h2 class="text-lg font-medium text-gray-900">
                        {{ __('Sicuro di voler cancellare l\'account?') }}
                    </h2>
                    <p class="mt-1 text-sm text-gray-600">
                        {{ __('Una volta cancellato, tutti i tuoi dati saranno perduti. Inserisci la password per confermare la cancellazione del tuo account.') }}
                    </p>
                </div>
